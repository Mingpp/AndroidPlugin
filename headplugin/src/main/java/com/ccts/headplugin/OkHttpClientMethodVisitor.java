...
public class OkHttpClientMethodVisitor extends MethodVisitor {
    ...
    private void injectLoggingInterceptor() {
        ...
        mv.visitTypeInsn(Opcodes.NEW, "org/example/visit/OkHttpClientMethodVisitor$HeadInterceptor");
        mv.visitInsn(Opcodes.DUP);
        mv.visitMethodInsn(Opcodes.INVOKESPECIAL, "org/example/visit/OkHttpClientMethodVisitor$HeadInterceptor", "<init>", "()V", false);
