...
public  class HighTransformTask extends DefaultTask {
    ...
    private File inputDir = new File("build/intermediates/javac/debug/compileDebugJavaWithJavac/classes/com/example/myapplication");
    private File outputDir = new File("build/intermediates/transforms/highTransform/debug/classes");
