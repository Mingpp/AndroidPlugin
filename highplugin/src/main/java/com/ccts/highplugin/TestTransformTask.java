...
public class TestTransformTask  {
    ...
    private static File inputDir = new File("D:\\Android_Project\\MyApplication3\\app\\build\\intermediates\\javac\\debug\\compileDebugJavaWithJavac\\classes\\com\\example\\myapplication");
    private static File outputDir = new File("D:\\release\\modify\\com\\example\\myapplication");
    // 设定输入和输出目录
...
//                    .replace(File.separatorChar, '.');
    ...
    private static byte[] referHackWhenInit(FileInputStream fis) throws IOException {
